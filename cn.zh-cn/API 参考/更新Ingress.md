# 更新Ingress<a name="patchExtensionsV1beta1NamespacedIngress"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=patchExtensionsV1beta1NamespacedIngress)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
将创建Ingress创建的Ingress的servicePort更新为8082。
