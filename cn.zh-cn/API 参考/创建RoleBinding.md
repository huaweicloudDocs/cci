# 创建RoleBinding<a name="cci_02_3188"></a>
...
<td class="cellrowborder" valign="top" width="43.43434343434344%" headers="mcps1.2.5.1.4 "><p id="p184171168106"><a name="p184171168106"></a><a name="p184171168106"></a>RoleRef can reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p id="p72861289222"><a name="p72861289222"></a><a name="p72861289222"></a><a href="数据结构.md#t693768b66dfa47239c0f155ad4dd18e8">initializers</a> object</p>
</td>
...
以角色绑定定义将允许用户“07b82a44a680d5661f01c00b448f8f50”从“rbac-test”命名空间中读取资源。
