# 更新Job<a name="patchBatchV1NamespacedJob"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=patchBatchV1NamespacedJob)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
为创建Job创建的Job添加一个label， Content-Type: application/merge-patch+json
