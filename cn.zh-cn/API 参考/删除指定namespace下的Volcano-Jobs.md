# 删除指定namespace下的Volcano Jobs<a name="deleteBatchVolcanoShV1alpha1CollectionNamespacedJob"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=deleteBatchVolcanoShV1alpha1CollectionNamespacedJob)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
**表 5**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails
...
**表 6**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause
...
**表 7**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta
