# 查询指定namespace下的ConfigMaps<a name="listCoreV1NamespacedConfigMap"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=listCoreV1NamespacedConfigMap)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
|items|Array of io.k8s.api.core.v1.ConfigMap objects|Items is the list of ConfigMaps.|
...
|metadata|io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta_v2 object|More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata|


**表 5**  io.k8s.api.core.v1.ConfigMap
