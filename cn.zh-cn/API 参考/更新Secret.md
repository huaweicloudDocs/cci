# 更新Secret<a name="patchCoreV1NamespacedSecret"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=patchCoreV1NamespacedSecret)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
“Content-Type”消息头说明请参见PATCH请求方法操作说明：https://support.huaweicloud.com/api-cci/cci\_02\_0070.html。
