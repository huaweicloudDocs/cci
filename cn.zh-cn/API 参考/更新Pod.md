# 更新Pod<a name="patchCoreV1NamespacedPod"></a>
...
-   spec.tolerations 其余部分不支持更新。


## 调试<a name="atuogenerate_1"></a>

您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=patchCoreV1NamespacedPod)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
将创建Pod创建的Pod的label更新为pod-test2。 Content-Type: application/merge-patch+json
