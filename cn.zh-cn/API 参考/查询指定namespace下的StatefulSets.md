# 查询指定namespace下的StatefulSets<a name="listAppsV1NamespacedStatefulSet"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=listAppsV1NamespacedStatefulSet)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
**表 95**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 96**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 97**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 98**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 99**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 100**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 110**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
