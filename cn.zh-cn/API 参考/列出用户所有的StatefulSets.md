# 列出用户所有的StatefulSets<a name="listAppsV1StatefulSetForAllNamespaces"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=listAppsV1StatefulSetForAllNamespaces)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
**表 4**  io.k8s.api.apps.v1.StatefulSet
...
**表 100**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 101**  io.k8s.api.core.v1.PersistentVolumeClaimSpec
...
**表 102**  io.k8s.api.core.v1.ResourceRequirements
...
**表 103**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 104**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 105**  io.k8s.api.core.v1.PersistentVolumeClaimStatus
...
**表 106**  io.k8s.api.core.v1.PersistentVolumeClaimCondition
...
**表 107**  io.k8s.api.apps.v1.StatefulSetStatus
...
**表 108**  io.k8s.api.apps.v1.StatefulSetCondition
...
**表 109**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
