# 创建Deployment<a name="createAppsV1NamespacedDeployment"></a>
...
**表 5**  io.k8s.api.apps.v1.DeploymentSpec

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|minReadySeconds|否|Integer|Minimum number of seconds for which a newly created pod should be ready without any of its container crashing, for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready)|
|paused|否|Boolean|Indicates that the deployment is paused.|
|progressDeadlineSeconds|否|Integer|The maximum time in seconds for a deployment to make progress before it is considered to be failed. The deployment controller will continue to process failed deployments and a condition with a ProgressDeadlineExceeded reason will be surfaced in the deployment status. Note that progress will not be estimated during the time a deployment is paused. Defaults to 600s.|
|replicas|否|Integer|Number of desired pods. This is a pointer to distinguish between explicit zero and not specified. Defaults to 1.|
|revisionHistoryLimit|否|Integer|The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified. Defaults to 10.|
|selector|是|io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector object|Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment. It must match the pod template's labels.|
|strategy|否|io.k8s.api.apps.v1.DeploymentStrategy object|The deployment strategy to use to replace existing pods with new ones.|
|template|是|io.k8s.api.core.v1.PodTemplateSpec object|Template describes the pods that will be created.|


**表 6**  io.k8s.api.apps.v1.DeploymentStrategy

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|rollingUpdate|否|io.k8s.api.apps.v1.RollingUpdateDeployment object|Rolling update config params. Present only if DeploymentStrategyType = RollingUpdate.|
|type|否|String|Type of deployment. Can be "Recreate" or "RollingUpdate". Default is RollingUpdate.|


**表 7**  io.k8s.api.apps.v1.RollingUpdateDeployment

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|maxSurge|否|String|The maximum number of pods that can be scheduled above the desired number of pods. Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%). This can not be 0 if MaxUnavailable is 0. Absolute number is calculated from percentage by rounding up. Defaults to 25%. Example: when this is set to 30%, the new ReplicaSet can be scaled up immediately when the rolling update starts, such that the total number of old and new pods do not exceed 130% of desired pods. Once old pods have been killed, new ReplicaSet can be scaled up further, ensuring that total number of pods running at any time during the update is at most 130% of desired pods.|
|maxUnavailable|否|String|The maximum number of pods that can be unavailable during the update. Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%). Absolute number is calculated from percentage by rounding down. This can not be 0 if MaxSurge is 0. Defaults to 25%. Example: when this is set to 30%, the old ReplicaSet can be scaled down to 70% of desired pods immediately when the rolling update starts. Once new pods are ready, old ReplicaSet can be scaled down further, followed by scaling up the new ReplicaSet, ensuring that the total number of pods available at all times during the update is at least 70% of desired pods.|


**表 8**  io.k8s.api.core.v1.PodTemplateSpec
...
**表 9**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 11**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 12**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 13**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 14**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 15**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 16**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 17**  io.k8s.api.core.v1.PodSpec
...
**表 22**  io.k8s.api.core.v1.NodeSelector
...
**表 23**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 24**  io.k8s.api.core.v1.PodAffinity
...
**表 25**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 26**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 27**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 34**  io.k8s.api.core.v1.Container
...
**表 35**  io.k8s.api.core.v1.EnvFromSource
...
**表 36**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 37**  io.k8s.api.core.v1.SecretEnvSource
...
**表 38**  io.k8s.api.core.v1.ContainerPort
...
**表 39**  io.k8s.api.core.v1.SecurityContext
...
**表 44**  io.k8s.api.core.v1.EnvVarSource
...
**表 45**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 46**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 47**  io.k8s.api.core.v1.SecretKeySelector
...
**表 48**  io.k8s.api.core.v1.Lifecycle
...
**表 49**  io.k8s.api.core.v1.Handler
...
**表 50**  io.k8s.api.core.v1.ObjectReference
...
**表 65**  io.k8s.api.core.v1.Toleration
...
**表 66**  io.k8s.api.core.v1.Volume
...
**表 67**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 68**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 69**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 70**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 71**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 72**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 73**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 74**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 75**  io.k8s.api.core.v1.FCVolumeSource
...
**表 92**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 93**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 94**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 95**  io.k8s.api.core.v1.SecretProjection
...
**表 96**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 97**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 101**  io.k8s.api.core.v1.KeyToPath
...
**表 102**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 103**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 104**  io.k8s.api.apps.v1.DeploymentStatus

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|availableReplicas|否|Integer|Total number of available pods (ready for at least minReadySeconds) targeted by this deployment.|
|collisionCount|否|Integer|Count of hash collisions for the Deployment. The Deployment controller uses this field as a collision avoidance mechanism when it needs to create the name for the newest ReplicaSet.|
|conditions|否|Array of io.k8s.api.apps.v1.DeploymentCondition objects|Represents the latest available observations of a deployment's current state.|
|observedGeneration|否|Long|The generation observed by the deployment controller.|
|readyReplicas|否|Integer|Total number of ready pods targeted by this deployment.|
|replicas|否|Integer|Total number of non-terminated pods targeted by this deployment (their labels match the selector).|
|unavailableReplicas|否|Integer|Total number of unavailable pods targeted by this deployment. This is the total number of pods that are still required for the deployment to have 100% available capacity. They may either be pods that are running but not yet available or pods that still have not been created.|
|updatedReplicas|否|Integer|Total number of non-terminated pods targeted by this deployment that have the desired template spec.|
...
**表 108**  io.k8s.api.apps.v1.DeploymentStrategy
...
**表 112**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 113**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 114**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 115**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 116**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 117**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 118**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 119**  io.k8s.api.core.v1.PodSpec
...
**表 120**  io.k8s.api.core.v1.Affinity
...
**表 121**  io.k8s.api.core.v1.NodeAffinity
...
**表 122**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 123**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 124**  io.k8s.api.core.v1.NodeSelector
...
**表 125**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 126**  io.k8s.api.core.v1.PodAffinity
...
**表 127**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 128**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 129**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 130**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 131**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 132**  io.k8s.api.core.v1.PodDNSConfig
...
**表 133**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 134**  io.k8s.api.core.v1.HostAlias
...
**表 135**  io.k8s.api.core.v1.LocalObjectReference
...
**表 136**  io.k8s.api.core.v1.Container
...
**表 137**  io.k8s.api.core.v1.EnvFromSource
...
**表 138**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 139**  io.k8s.api.core.v1.SecretEnvSource
...
**表 140**  io.k8s.api.core.v1.ContainerPort
...
**表 141**  io.k8s.api.core.v1.SecurityContext
...
**表 142**  io.k8s.api.core.v1.Capabilities
...
**表 143**  io.k8s.api.core.v1.VolumeDevice
...
**表 144**  io.k8s.api.core.v1.Process
...
**表 145**  io.k8s.api.core.v1.EnvVar
...
**表 146**  io.k8s.api.core.v1.EnvVarSource
...
**表 147**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 148**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 149**  io.k8s.api.core.v1.SecretKeySelector
...
**表 150**  io.k8s.api.core.v1.Lifecycle
...
**表 151**  io.k8s.api.core.v1.Handler
...
**表 152**  io.k8s.api.core.v1.ObjectReference
...
**表 154**  io.k8s.api.core.v1.Probe
...
**表 155**  io.k8s.api.core.v1.ExecAction
...
**表 156**  io.k8s.api.core.v1.HTTPGetAction
...
**表 157**  io.k8s.api.core.v1.HTTPHeader
...
**表 158**  io.k8s.api.core.v1.TCPSocketAction
...
**表 159**  io.k8s.api.core.v1.ResourceRequirements
...
**表 160**  io.k8s.api.core.v1.VolumeMount
...
**表 161**  io.k8s.api.core.v1.Policy
...
**表 163**  io.k8s.api.core.v1.PodReadinessGate
...
**表 164**  io.k8s.api.core.v1.PodSecurityContext
...
**表 165**  io.k8s.api.core.v1.SELinuxOptions
...
**表 166**  io.k8s.api.core.v1.Sysctl
...
**表 167**  io.k8s.api.core.v1.Toleration
...
**表 168**  io.k8s.api.core.v1.Volume
...
**表 169**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 170**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 171**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 172**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 173**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 174**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 175**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 176**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 177**  io.k8s.api.core.v1.FCVolumeSource
...
**表 178**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 179**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 180**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 181**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 182**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 183**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 184**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 185**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 186**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 187**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 188**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 189**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 190**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 191**  io.k8s.api.core.v1.VolumeProjection
...
**表 192**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 193**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 194**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 195**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 196**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 197**  io.k8s.api.core.v1.SecretProjection
...
**表 198**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 199**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 200**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 201**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 202**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 203**  io.k8s.api.core.v1.KeyToPath
...
**表 204**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 205**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 206**  io.k8s.api.apps.v1.DeploymentStatus
...
|conditions|Array of io.k8s.api.apps.v1.DeploymentCondition objects|Represents the latest available observations of a deployment's current state.|
|observedGeneration|Long|The generation observed by the deployment controller.|
...
**表 207**  io.k8s.api.apps.v1.DeploymentCondition
...
**表 209**  io.k8s.api.apps.v1.DeploymentSpec
...
**表 210**  io.k8s.api.apps.v1.DeploymentStrategy
...
**表 211**  io.k8s.api.apps.v1.RollingUpdateDeployment
...
**表 212**  io.k8s.api.core.v1.PodTemplateSpec
...
**表 213**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 214**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 215**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 216**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 217**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 218**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 219**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 220**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 221**  io.k8s.api.core.v1.PodSpec
...
**表 222**  io.k8s.api.core.v1.Affinity
...
**表 223**  io.k8s.api.core.v1.NodeAffinity
...
**表 224**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 225**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 226**  io.k8s.api.core.v1.NodeSelector
...
**表 227**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 228**  io.k8s.api.core.v1.PodAffinity
...
**表 229**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 230**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 231**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 232**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 233**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 234**  io.k8s.api.core.v1.PodDNSConfig
...
**表 235**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 236**  io.k8s.api.core.v1.HostAlias
...
**表 237**  io.k8s.api.core.v1.LocalObjectReference
...
**表 238**  io.k8s.api.core.v1.Container
...
**表 239**  io.k8s.api.core.v1.EnvFromSource
...
**表 240**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 241**  io.k8s.api.core.v1.SecretEnvSource
...
**表 242**  io.k8s.api.core.v1.ContainerPort
...
**表 243**  io.k8s.api.core.v1.SecurityContext
...
**表 244**  io.k8s.api.core.v1.Capabilities
...
**表 245**  io.k8s.api.core.v1.VolumeDevice
...
**表 246**  io.k8s.api.core.v1.Process
...
**表 247**  io.k8s.api.core.v1.EnvVar
...
**表 248**  io.k8s.api.core.v1.EnvVarSource
...
**表 249**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 250**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 251**  io.k8s.api.core.v1.SecretKeySelector
...
**表 252**  io.k8s.api.core.v1.Lifecycle
...
**表 253**  io.k8s.api.core.v1.Handler
...
**表 254**  io.k8s.api.core.v1.ObjectReference
...
**表 256**  io.k8s.api.core.v1.Probe
...
**表 257**  io.k8s.api.core.v1.ExecAction
...
**表 258**  io.k8s.api.core.v1.HTTPGetAction
...
**表 259**  io.k8s.api.core.v1.HTTPHeader
...
**表 260**  io.k8s.api.core.v1.TCPSocketAction
...
**表 261**  io.k8s.api.core.v1.ResourceRequirements
...
**表 262**  io.k8s.api.core.v1.VolumeMount
...
**表 263**  io.k8s.api.core.v1.Policy
...
**表 265**  io.k8s.api.core.v1.PodReadinessGate
...
**表 266**  io.k8s.api.core.v1.PodSecurityContext
...
**表 267**  io.k8s.api.core.v1.SELinuxOptions
...
**表 268**  io.k8s.api.core.v1.Sysctl
...
**表 269**  io.k8s.api.core.v1.Toleration
...
**表 270**  io.k8s.api.core.v1.Volume
...
**表 271**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 272**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 273**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 274**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 275**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 276**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 277**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 278**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 279**  io.k8s.api.core.v1.FCVolumeSource
...
**表 280**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 281**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 282**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 283**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 284**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 285**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 286**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 287**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 288**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 289**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 290**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 291**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 292**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 293**  io.k8s.api.core.v1.VolumeProjection
...
**表 294**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 295**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 296**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 297**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 298**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 299**  io.k8s.api.core.v1.SecretProjection
...
**表 300**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 301**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 302**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 303**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 304**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 305**  io.k8s.api.core.v1.KeyToPath
...
**表 306**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 307**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 308**  io.k8s.api.apps.v1.DeploymentStatus
...
**表 309**  io.k8s.api.apps.v1.DeploymentCondition
...
**表 311**  io.k8s.api.apps.v1.DeploymentSpec
...
**表 312**  io.k8s.api.apps.v1.DeploymentStrategy
...
**表 313**  io.k8s.api.apps.v1.RollingUpdateDeployment
...
**表 314**  io.k8s.api.core.v1.PodTemplateSpec
...
**表 315**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 316**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 317**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 318**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 319**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 320**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 321**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 322**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 323**  io.k8s.api.core.v1.PodSpec
...
**表 324**  io.k8s.api.core.v1.Affinity
...
**表 325**  io.k8s.api.core.v1.NodeAffinity
...
**表 326**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 327**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 328**  io.k8s.api.core.v1.NodeSelector
...
**表 329**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 330**  io.k8s.api.core.v1.PodAffinity
...
**表 331**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 332**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 333**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 334**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 335**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 363**  io.k8s.api.core.v1.ResourceRequirements
...
**表 364**  io.k8s.api.core.v1.VolumeMount
...
**表 365**  io.k8s.api.core.v1.Policy
...
**表 367**  io.k8s.api.core.v1.PodReadinessGate
...
**表 368**  io.k8s.api.core.v1.PodSecurityContext
...
**表 369**  io.k8s.api.core.v1.SELinuxOptions
...
**表 370**  io.k8s.api.core.v1.Sysctl
...
**表 371**  io.k8s.api.core.v1.Toleration
...
**表 372**  io.k8s.api.core.v1.Volume
...
**表 373**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 374**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 375**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 376**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 377**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 378**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 379**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 380**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 381**  io.k8s.api.core.v1.FCVolumeSource
...
**表 382**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 383**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 384**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 385**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 386**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 387**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 388**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 389**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 390**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 391**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 392**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 393**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 394**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 395**  io.k8s.api.core.v1.VolumeProjection
...
**表 396**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 397**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 398**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 399**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 400**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 401**  io.k8s.api.core.v1.SecretProjection
...
**表 402**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 403**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 404**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 405**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 406**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 407**  io.k8s.api.core.v1.KeyToPath
...
**表 408**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 409**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 410**  io.k8s.api.apps.v1.DeploymentStatus
...
**表 411**  io.k8s.api.apps.v1.DeploymentCondition
