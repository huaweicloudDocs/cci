# 创建Pod<a name="createCoreV1NamespacedPod"></a>
...
>说明： Pod的生命周期是短暂的，Pod是用后即焚的实体。在实际使用中，请谨慎单独创建Pod，请使用Deployment、StatefulSet和Job这些控制器创建应用，从而保障应用高可用。

云容器实例中Pod规格有限制，具体的限制请参见[约束限制](约束限制.md)页面的“Pod规格”部分。

当前支持使用Nvidia GPU的驱动版本为418.126和460.106，您应用程序中使用的CUDA需满足如下表所示的配套关系。CUDA与驱动的配套关系来源于Nvidia官网，详细信息请参见[CUDA Compatibility](https://docs.nvidia.com/deploy/cuda-compatibility/index.html)。

表：NVIDIA GPU驱动与CUDA配套关系
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=createCoreV1NamespacedPod)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
**表 332**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 333**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 334**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 335**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 336**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 337**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 338**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 339**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 340**  io.k8s.api.core.v1.PodSpec
...
**表 341**  io.k8s.api.core.v1.Affinity
...
**表 342**  io.k8s.api.core.v1.NodeAffinity
...
**表 343**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 344**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 345**  io.k8s.api.core.v1.NodeSelector
...
**表 346**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 347**  io.k8s.api.core.v1.PodAffinity
...
**表 348**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 349**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 350**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 351**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 352**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 353**  io.k8s.api.core.v1.PodDNSConfig
...
**表 354**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 355**  io.k8s.api.core.v1.HostAlias
...
**表 356**  io.k8s.api.core.v1.LocalObjectReference
...
**表 357**  io.k8s.api.core.v1.Container
...
**表 358**  io.k8s.api.core.v1.EnvFromSource
...
**表 359**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 360**  io.k8s.api.core.v1.SecretEnvSource
...
**表 361**  io.k8s.api.core.v1.ContainerPort
...
**表 362**  io.k8s.api.core.v1.SecurityContext
...
**表 363**  io.k8s.api.core.v1.Capabilities
...
**表 364**  io.k8s.api.core.v1.VolumeDevice
...
**表 365**  io.k8s.api.core.v1.Process
...
**表 366**  io.k8s.api.core.v1.EnvVar
...
**表 367**  io.k8s.api.core.v1.EnvVarSource
...
**表 368**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 369**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 370**  io.k8s.api.core.v1.SecretKeySelector
...
**表 371**  io.k8s.api.core.v1.Lifecycle
...
**表 372**  io.k8s.api.core.v1.Handler
...
**表 373**  io.k8s.api.core.v1.ObjectReference
...
**表 375**  io.k8s.api.core.v1.Probe
...
**表 376**  io.k8s.api.core.v1.ExecAction
...
**表 377**  io.k8s.api.core.v1.HTTPGetAction
...
**表 378**  io.k8s.api.core.v1.HTTPHeader
...
**表 379**  io.k8s.api.core.v1.TCPSocketAction
...
**表 380**  io.k8s.api.core.v1.ResourceRequirements
...
**表 381**  io.k8s.api.core.v1.VolumeMount
...
**表 382**  io.k8s.api.core.v1.Policy
...
**表 384**  io.k8s.api.core.v1.PodReadinessGate
...
**表 385**  io.k8s.api.core.v1.PodSecurityContext
...
**表 386**  io.k8s.api.core.v1.SELinuxOptions
...
**表 387**  io.k8s.api.core.v1.Sysctl
...
**表 388**  io.k8s.api.core.v1.Toleration
...
**表 389**  io.k8s.api.core.v1.Volume
...
**表 390**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 391**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 392**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 393**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 394**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 395**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 396**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 397**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 398**  io.k8s.api.core.v1.FCVolumeSource
...
**表 399**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 400**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 401**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 402**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 403**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 404**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 405**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 406**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 407**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 408**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 409**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 410**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 411**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 412**  io.k8s.api.core.v1.VolumeProjection
...
**表 413**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 414**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 415**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 416**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 417**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 418**  io.k8s.api.core.v1.SecretProjection
...
**表 419**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 420**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 421**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 422**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 423**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 424**  io.k8s.api.core.v1.KeyToPath
...
**表 425**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 426**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 427**  io.k8s.api.core.v1.PodStatus
...
**表 428**  io.k8s.api.core.v1.PodCondition
...
**表 429**  io.k8s.api.core.v1.ContainerStatus
...
**表 430**  io.k8s.api.core.v1.ContainerState
...
**表 431**  io.k8s.api.core.v1.ContainerStateRunning
...
**表 432**  io.k8s.api.core.v1.ContainerStateTerminated
...
**表 433**  io.k8s.api.core.v1.ContainerStateWaiting
...
**表 434**  io.k8s.api.core.v1.PodNetworkInterface
...
**表 435**  io.k8s.api.core.v1.ProcessStatus
...
**表 436**  io.k8s.api.core.v1.ProcessState
...
**表 437**  io.k8s.api.core.v1.ProcessStateRunning
...
**表 438**  io.k8s.api.core.v1.ProcessStateTerminated
...
**表 439**  io.k8s.api.core.v1.ProcessStateWaiting
