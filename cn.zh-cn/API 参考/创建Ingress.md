# 创建Ingress<a name="createExtensionsV1beta1NamespacedIngress"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=createExtensionsV1beta1NamespacedIngress)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
**表 59**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 60**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 61**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 62**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 63**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 64**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 65**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 66**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 67**  io.k8s.api.extensions.v1beta1.IngressSpec
...
**表 68**  io.k8s.api.extensions.v1beta1.IngressRule
...
**表 69**  io.k8s.api.extensions.v1beta1.HTTPIngressRuleValue
...
**表 70**  io.k8s.api.extensions.v1beta1.HTTPIngressPath
...
**表 71**  io.k8s.api.extensions.v1beta1.IngressBackend
...
**表 72**  io.k8s.api.extensions.v1beta1.IngressTLS
...
**表 73**  io.k8s.api.extensions.v1beta1.IngressStatus
...
**表 74**  io.k8s.api.core.v1.LoadBalancerStatus
...
**表 75**  io.k8s.api.core.v1.LoadBalancerIngress
