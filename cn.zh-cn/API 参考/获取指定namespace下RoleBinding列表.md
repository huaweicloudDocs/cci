# 获取指定namespace下RoleBinding列表<a name="listRbacAuthorizationV1NamespacedRoleBinding"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=listRbacAuthorizationV1NamespacedRoleBinding)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
**表 5**  io.k8s.api.rbac.v1.RoleBinding
