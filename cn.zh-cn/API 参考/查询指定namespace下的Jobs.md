# 查询指定namespace下的Jobs<a name="listBatchV1NamespacedJob"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=listBatchV1NamespacedJob)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
**表 6**  io.k8s.api.batch.v1.JobSpec
...
**表 104**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
