# 查询指定namespace下的Networks<a name="listNetworkingCciIoV1beta1NamespacedNetwork"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=listNetworkingCciIoV1beta1NamespacedNetwork)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
|items|Array of io.k8s.api.cci.v1beta1.Network objects|Network is a network resource in container.|
...
**表 5**  io.k8s.api.cci.v1beta1.Network
