# 查询指定namespace下的PersistentVolumeClaims<a name="listCoreV1NamespacedPersistentVolumeClaim"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=listCoreV1NamespacedPersistentVolumeClaim)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
|items|Array of io.k8s.api.core.v1.PersistentVolumeClaim objects|A list of persistent volume claims. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims|
...
**表 5**  io.k8s.api.core.v1.PersistentVolumeClaim
...
**表 19**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
