# 查询指定namespace下的Deployments<a name="listAppsV1NamespacedDeployment"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=listAppsV1NamespacedDeployment)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
**表 5**  io.k8s.api.apps.v1.Deployment
...
**表 6**  io.k8s.api.apps.v1.DeploymentSpec
...
**表 7**  io.k8s.api.apps.v1.DeploymentStrategy
...
**表 8**  io.k8s.api.apps.v1.RollingUpdateDeployment
...
**表 9**  io.k8s.api.core.v1.PodTemplateSpec
...
**表 10**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 11**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 12**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 13**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 14**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 15**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 106**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
