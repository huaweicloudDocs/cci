# 创建Secret<a name="createCoreV1NamespacedSecret"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=createCoreV1NamespacedSecret)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
|data|否|Map<String,String>|Data contains the secret data. Each key must consist of alphanumeric characters, '-', '_' or '.'. The serialized form of the secret data is a base64 encoded string, representing the arbitrary (possibly non-string) data value here. Described in https://tools.ietf.org/html/rfc4648#section-4|
...
|stringData|否|Map<String,String>|stringData allows specifying non-binary secret data in string form. It is provided as a write-only convenience method. All keys and values are merged into the data field on write, overwriting any existing values. It is never output when reading from the API.|
|type|否|String|Used to facilitate programmatic handling of secret data.|
...
|data|Map<String,String>|Data contains the secret data. Each key must consist of alphanumeric characters, '-', '_' or '.'. The serialized form of the secret data is a base64 encoded string, representing the arbitrary (possibly non-string) data value here. Described in https://tools.ietf.org/html/rfc4648#section-4|
...
|stringData|Map<String,String>|stringData allows specifying non-binary secret data in string form. It is provided as a write-only convenience method. All keys and values are merged into the data field on write, overwriting any existing values. It is never output when reading from the API.|
|type|String|Used to facilitate programmatic handling of secret data.|


**表 14**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 15**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 16**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 17**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 18**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 19**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 21**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 32**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 33**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 34**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 35**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 36**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 37**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 38**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 39**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
