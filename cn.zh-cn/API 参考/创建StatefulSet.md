# 创建StatefulSet<a name="createAppsV1NamespacedStatefulSet"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=createAppsV1NamespacedStatefulSet)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
|metadata|否|io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta_v3 object|ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.|
|spec|否|io.k8s.api.apps.v1.StatefulSetSpec object|Spec defines the desired identities of pods in this set.|
|status|否|io.k8s.api.apps.v1.StatefulSetStatus object|Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.|


**表 5**  io.k8s.api.apps.v1.StatefulSetSpec

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|podManagementPolicy|否|String|podManagementPolicy controls how pods are created during initial scale up, when replacing pods on nodes, or when scaling down. The default policy is *OrderedReady*, where pods are created in increasing order (pod-0, then pod-1, etc) and the controller will wait until each pod is ready before continuing. When scaling down, the pods are removed in the opposite order. The alternative policy is *Parallel* which will create pods in parallel to match the desired scale without waiting, and on scale down will delete all pods at once.|
|replicas|否|Integer|replicas is the desired number of replicas of the given Template. These are replicas in the sense that they are instantiations of the same Template, but individual replicas also have a consistent identity. If unspecified, defaults to 1.|
|revisionHistoryLimit|否|Integer|revisionHistoryLimit is the maximum number of revisions that will be maintained in the StatefulSet's revision history. The revision history consists of all revisions not represented by a currently applied StatefulSetSpec version. The default value is 10.|
|selector|是|io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector object|selector is a label query over pods that should match the replica count. It must match the pod template's labels. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors|
|serviceName|是|String|serviceName is the name of the service that governs this StatefulSet. This service must exist before the StatefulSet, and is responsible for the network identity of the set. Pods get DNS/hostnames that follow the pattern: pod-specific-string.serviceName.default.svc.cluster.local where "pod-specific-string" is managed by the StatefulSet controller.|
|template|是|io.k8s.api.core.v1.PodTemplateSpec object|template is the object that describes the pod that will be created if insufficient replicas are detected. Each pod stamped out by the StatefulSet will fulfill this Template, but have a unique identity from the rest of the StatefulSet.|
|updateStrategy|否|io.k8s.api.apps.v1.StatefulSetUpdateStrategy object|updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template.|
...
**表 6**  io.k8s.api.core.v1.PodTemplateSpec
...
|spec|否|io.k8s.api.core.v1.PodSpec object|Specification of the desired behavior of the pod. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status|


**表 7**  io.k8s.api.core.v1.PodSpec
...
**表 8**  io.k8s.api.core.v1.Affinity
...
**表 9**  io.k8s.api.core.v1.NodeAffinity
...
**表 10**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 11**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 12**  io.k8s.api.core.v1.NodeSelector
...
**表 13**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 14**  io.k8s.api.core.v1.PodAffinity
...
**表 15**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 16**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 17**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 18**  io.k8s.api.core.v1.PodDNSConfig
...
**表 19**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 20**  io.k8s.api.core.v1.HostAlias
...
**表 21**  io.k8s.api.core.v1.LocalObjectReference
...
**表 22**  io.k8s.api.core.v1.Container
...
**表 23**  io.k8s.api.core.v1.EnvFromSource
...
**表 24**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 25**  io.k8s.api.core.v1.SecretEnvSource
...
**表 26**  io.k8s.api.core.v1.ContainerPort
...
**表 27**  io.k8s.api.core.v1.SecurityContext
...
**表 28**  io.k8s.api.core.v1.Capabilities
...
**表 29**  io.k8s.api.core.v1.VolumeDevice
...
**表 30**  io.k8s.api.core.v1.Process
...
**表 31**  io.k8s.api.core.v1.EnvVar
...
**表 32**  io.k8s.api.core.v1.EnvVarSource
...
**表 33**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 34**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 35**  io.k8s.api.core.v1.SecretKeySelector
...
**表 36**  io.k8s.api.core.v1.Lifecycle
...
**表 37**  io.k8s.api.core.v1.Handler
...
**表 38**  io.k8s.api.core.v1.ObjectReference
...
**表 41**  io.k8s.api.core.v1.ExecAction
...
**表 42**  io.k8s.api.core.v1.HTTPGetAction
...
**表 43**  io.k8s.api.core.v1.HTTPHeader
...
**表 44**  io.k8s.api.core.v1.TCPSocketAction
...
**表 45**  io.k8s.api.core.v1.VolumeMount
...
**表 46**  io.k8s.api.core.v1.Policy
...
**表 48**  io.k8s.api.core.v1.PodReadinessGate
...
**表 49**  io.k8s.api.core.v1.PodSecurityContext
...
**表 50**  io.k8s.api.core.v1.SELinuxOptions
...
**表 51**  io.k8s.api.core.v1.Sysctl
...
**表 52**  io.k8s.api.core.v1.Toleration
...
**表 53**  io.k8s.api.core.v1.Volume
...
**表 54**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 55**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 56**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 57**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 58**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 59**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 60**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 61**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 62**  io.k8s.api.core.v1.FCVolumeSource
...
**表 63**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 64**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 65**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 66**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 67**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 68**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 69**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 70**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 71**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 72**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 73**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 74**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 75**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 76**  io.k8s.api.core.v1.VolumeProjection
...
**表 77**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 78**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 79**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 80**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 81**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 82**  io.k8s.api.core.v1.SecretProjection
...
**表 83**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 84**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 85**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 86**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 87**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 88**  io.k8s.api.core.v1.KeyToPath
...
**表 89**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 90**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 91**  io.k8s.api.apps.v1.StatefulSetUpdateStrategy

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|rollingUpdate|否|io.k8s.api.apps.v1.RollingUpdateStatefulSetStrategy object|RollingUpdate is used to communicate parameters when Type is RollingUpdateStatefulSetStrategyType.|
|type|否|String|Type indicates the type of the StatefulSetUpdateStrategy. Default is RollingUpdate.|


**表 92**  io.k8s.api.apps.v1.RollingUpdateStatefulSetStrategy

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|partition|否|Integer|Partition indicates the ordinal at which the StatefulSet should be partitioned. Default value is 0.|


**表 93**  io.k8s.api.core.v1.PersistentVolumeClaim
...
**表 94**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 95**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 96**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 97**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 98**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 99**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 100**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 101**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
|参数|是否必选|参数类型|描述|
|--|--|--|--|
|collisionCount|否|Integer|collisionCount is the count of hash collisions for the StatefulSet. The StatefulSet controller uses this field as a collision avoidance mechanism when it needs to create the name for the newest ControllerRevision.|
|conditions|否|Array of io.k8s.api.apps.v1.StatefulSetCondition objects|Represents the latest available observations of a statefulset's current state.|
|currentReplicas|否|Integer|currentReplicas is the number of Pods created by the StatefulSet controller from the StatefulSet version indicated by currentRevision.|
|currentRevision|否|String|currentRevision, if not empty, indicates the version of the StatefulSet used to generate Pods in the sequence [0,currentReplicas).|
|observedGeneration|否|Long|observedGeneration is the most recent generation observed for this StatefulSet. It corresponds to the StatefulSet's generation, which is updated on mutation by the API Server.|
|readyReplicas|否|Integer|readyReplicas is the number of Pods created by the StatefulSet controller that have a Ready Condition.|
|replicas|是|Integer|replicas is the number of Pods created by the StatefulSet controller.|
|updateRevision|否|String|updateRevision, if not empty, indicates the version of the StatefulSet used to generate Pods in the sequence [replicas-updatedReplicas,replicas)|
|updatedReplicas|否|Integer|updatedReplicas is the number of Pods created by the StatefulSet controller from the StatefulSet version indicated by updateRevision.|
...
|type|是|String|Type of statefulset condition.|
...
**表 111**  io.k8s.api.apps.v1.StatefulSetSpec
...
**表 112**  io.k8s.api.core.v1.PodTemplateSpec
...
**表 113**  io.k8s.api.core.v1.PodSpec
...
**表 114**  io.k8s.api.core.v1.Affinity
...
**表 115**  io.k8s.api.core.v1.NodeAffinity
...
**表 116**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 117**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 118**  io.k8s.api.core.v1.NodeSelector
...
**表 119**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 120**  io.k8s.api.core.v1.PodAffinity
...
**表 121**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 122**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 123**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 124**  io.k8s.api.core.v1.PodDNSConfig
...
**表 125**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 126**  io.k8s.api.core.v1.HostAlias
...
**表 127**  io.k8s.api.core.v1.LocalObjectReference
...
**表 128**  io.k8s.api.core.v1.Container
...
**表 129**  io.k8s.api.core.v1.EnvFromSource
...
**表 130**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 131**  io.k8s.api.core.v1.SecretEnvSource
...
**表 132**  io.k8s.api.core.v1.ContainerPort
...
**表 133**  io.k8s.api.core.v1.SecurityContext
...
**表 134**  io.k8s.api.core.v1.Capabilities
...
**表 135**  io.k8s.api.core.v1.VolumeDevice
...
**表 136**  io.k8s.api.core.v1.Process
...
**表 137**  io.k8s.api.core.v1.EnvVar
...
**表 138**  io.k8s.api.core.v1.EnvVarSource
...
**表 139**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 140**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 141**  io.k8s.api.core.v1.SecretKeySelector
...
**表 142**  io.k8s.api.core.v1.Lifecycle
...
**表 143**  io.k8s.api.core.v1.Handler
...
**表 144**  io.k8s.api.core.v1.ObjectReference
...
**表 146**  io.k8s.api.core.v1.Probe
...
**表 147**  io.k8s.api.core.v1.ExecAction
...
**表 148**  io.k8s.api.core.v1.HTTPGetAction
...
**表 149**  io.k8s.api.core.v1.HTTPHeader
...
**表 150**  io.k8s.api.core.v1.TCPSocketAction
...
**表 151**  io.k8s.api.core.v1.VolumeMount
...
**表 152**  io.k8s.api.core.v1.Policy
...
**表 154**  io.k8s.api.core.v1.PodReadinessGate
...
**表 155**  io.k8s.api.core.v1.PodSecurityContext
...
**表 156**  io.k8s.api.core.v1.SELinuxOptions
...
**表 157**  io.k8s.api.core.v1.Sysctl
...
**表 158**  io.k8s.api.core.v1.Toleration
...
**表 159**  io.k8s.api.core.v1.Volume
...
**表 160**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 161**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 162**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 163**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 164**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 165**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 166**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 167**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 168**  io.k8s.api.core.v1.FCVolumeSource
...
**表 169**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 170**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 171**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 172**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 173**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 174**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 175**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 176**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 177**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 178**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 179**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 180**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 181**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 182**  io.k8s.api.core.v1.VolumeProjection
...
**表 183**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 184**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 185**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 186**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 187**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 188**  io.k8s.api.core.v1.SecretProjection
...
**表 189**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 190**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 191**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 192**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 193**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 194**  io.k8s.api.core.v1.KeyToPath
...
**表 195**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 196**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 197**  io.k8s.api.apps.v1.StatefulSetUpdateStrategy
...
**表 198**  io.k8s.api.apps.v1.RollingUpdateStatefulSetStrategy
...
**表 199**  io.k8s.api.core.v1.PersistentVolumeClaim
...
**表 200**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 201**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 202**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 203**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 204**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 205**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 206**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 207**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 208**  io.k8s.api.core.v1.PersistentVolumeClaimSpec
...
**表 209**  io.k8s.api.core.v1.ResourceRequirements
...
**表 210**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 211**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 212**  io.k8s.api.core.v1.PersistentVolumeClaimStatus
...
**表 213**  io.k8s.api.core.v1.PersistentVolumeClaimCondition
...
**表 214**  io.k8s.api.apps.v1.StatefulSetStatus
...
**表 215**  io.k8s.api.apps.v1.StatefulSetCondition
...
**表 217**  io.k8s.api.apps.v1.StatefulSetSpec
...
**表 218**  io.k8s.api.core.v1.PodTemplateSpec
...
**表 219**  io.k8s.api.core.v1.PodSpec
...
**表 220**  io.k8s.api.core.v1.Affinity
...
**表 221**  io.k8s.api.core.v1.NodeAffinity
...
**表 222**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 223**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 224**  io.k8s.api.core.v1.NodeSelector
...
**表 225**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 226**  io.k8s.api.core.v1.PodAffinity
...
**表 227**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 228**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 229**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 230**  io.k8s.api.core.v1.PodDNSConfig
...
**表 231**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 232**  io.k8s.api.core.v1.HostAlias
...
**表 233**  io.k8s.api.core.v1.LocalObjectReference
...
**表 234**  io.k8s.api.core.v1.Container
...
**表 235**  io.k8s.api.core.v1.EnvFromSource
...
**表 236**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 237**  io.k8s.api.core.v1.SecretEnvSource
...
**表 238**  io.k8s.api.core.v1.ContainerPort
...
**表 239**  io.k8s.api.core.v1.SecurityContext
...
**表 240**  io.k8s.api.core.v1.Capabilities
...
**表 241**  io.k8s.api.core.v1.VolumeDevice
...
**表 242**  io.k8s.api.core.v1.Process
...
**表 243**  io.k8s.api.core.v1.EnvVar
...
**表 244**  io.k8s.api.core.v1.EnvVarSource
...
**表 245**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 246**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 247**  io.k8s.api.core.v1.SecretKeySelector
...
**表 248**  io.k8s.api.core.v1.Lifecycle
...
**表 249**  io.k8s.api.core.v1.Handler
...
**表 250**  io.k8s.api.core.v1.ObjectReference
...
**表 252**  io.k8s.api.core.v1.Probe
...
**表 253**  io.k8s.api.core.v1.ExecAction
...
**表 254**  io.k8s.api.core.v1.HTTPGetAction
...
**表 255**  io.k8s.api.core.v1.HTTPHeader
...
**表 256**  io.k8s.api.core.v1.TCPSocketAction
...
**表 257**  io.k8s.api.core.v1.VolumeMount
...
**表 258**  io.k8s.api.core.v1.Policy
...
**表 260**  io.k8s.api.core.v1.PodReadinessGate
...
**表 261**  io.k8s.api.core.v1.PodSecurityContext
...
**表 262**  io.k8s.api.core.v1.SELinuxOptions
...
**表 263**  io.k8s.api.core.v1.Sysctl
...
**表 264**  io.k8s.api.core.v1.Toleration
...
**表 265**  io.k8s.api.core.v1.Volume
...
**表 266**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 267**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 268**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 269**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 270**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 271**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 272**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 273**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 274**  io.k8s.api.core.v1.FCVolumeSource
...
**表 275**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 276**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 277**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 278**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 279**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 280**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 281**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 282**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 283**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 284**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 285**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 286**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 287**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 288**  io.k8s.api.core.v1.VolumeProjection
...
**表 289**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 290**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 291**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 292**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 293**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 294**  io.k8s.api.core.v1.SecretProjection
...
**表 295**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 296**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 297**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 298**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 299**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 300**  io.k8s.api.core.v1.KeyToPath
...
**表 301**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 302**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 303**  io.k8s.api.apps.v1.StatefulSetUpdateStrategy
...
**表 304**  io.k8s.api.apps.v1.RollingUpdateStatefulSetStrategy
...
**表 305**  io.k8s.api.core.v1.PersistentVolumeClaim
...
**表 306**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 307**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 308**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 309**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 310**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 311**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 312**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 313**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 314**  io.k8s.api.core.v1.PersistentVolumeClaimSpec
...
**表 315**  io.k8s.api.core.v1.ResourceRequirements
...
**表 316**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 317**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 318**  io.k8s.api.core.v1.PersistentVolumeClaimStatus
...
**表 319**  io.k8s.api.core.v1.PersistentVolumeClaimCondition
...
**表 320**  io.k8s.api.apps.v1.StatefulSetStatus
...
**表 321**  io.k8s.api.apps.v1.StatefulSetCondition
...
**表 323**  io.k8s.api.apps.v1.StatefulSetSpec
...
**表 324**  io.k8s.api.core.v1.PodTemplateSpec
...
**表 325**  io.k8s.api.core.v1.PodSpec
...
**表 326**  io.k8s.api.core.v1.Affinity
...
**表 327**  io.k8s.api.core.v1.NodeAffinity
...
**表 328**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 329**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 330**  io.k8s.api.core.v1.NodeSelector
...
**表 331**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 332**  io.k8s.api.core.v1.PodAffinity
...
**表 333**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 334**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 335**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 336**  io.k8s.api.core.v1.PodDNSConfig
...
**表 337**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 338**  io.k8s.api.core.v1.HostAlias
...
**表 339**  io.k8s.api.core.v1.LocalObjectReference
...
**表 340**  io.k8s.api.core.v1.Container
...
**表 341**  io.k8s.api.core.v1.EnvFromSource
...
**表 342**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 343**  io.k8s.api.core.v1.SecretEnvSource
...
**表 344**  io.k8s.api.core.v1.ContainerPort
...
**表 345**  io.k8s.api.core.v1.SecurityContext
...
**表 346**  io.k8s.api.core.v1.Capabilities
...
**表 347**  io.k8s.api.core.v1.VolumeDevice
...
**表 348**  io.k8s.api.core.v1.Process
...
**表 349**  io.k8s.api.core.v1.EnvVar
...
**表 350**  io.k8s.api.core.v1.EnvVarSource
...
**表 351**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 352**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 353**  io.k8s.api.core.v1.SecretKeySelector
...
**表 354**  io.k8s.api.core.v1.Lifecycle
...
**表 355**  io.k8s.api.core.v1.Handler
...
**表 356**  io.k8s.api.core.v1.ObjectReference
...
**表 358**  io.k8s.api.core.v1.Probe
...
**表 359**  io.k8s.api.core.v1.ExecAction
...
**表 360**  io.k8s.api.core.v1.HTTPGetAction
...
**表 361**  io.k8s.api.core.v1.HTTPHeader
...
**表 362**  io.k8s.api.core.v1.TCPSocketAction
...
**表 363**  io.k8s.api.core.v1.VolumeMount
...
**表 364**  io.k8s.api.core.v1.Policy
...
**表 366**  io.k8s.api.core.v1.PodReadinessGate
...
**表 367**  io.k8s.api.core.v1.PodSecurityContext
...
**表 368**  io.k8s.api.core.v1.SELinuxOptions
...
**表 369**  io.k8s.api.core.v1.Sysctl
...
**表 370**  io.k8s.api.core.v1.Toleration
...
**表 371**  io.k8s.api.core.v1.Volume
...
**表 372**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 373**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 374**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 375**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 376**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 377**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 378**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 379**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 380**  io.k8s.api.core.v1.FCVolumeSource
...
**表 381**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 382**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 383**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 384**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 385**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 386**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 387**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 388**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 389**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 390**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 391**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 392**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 393**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 394**  io.k8s.api.core.v1.VolumeProjection
...
**表 395**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 396**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 397**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 398**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 399**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 400**  io.k8s.api.core.v1.SecretProjection
...
**表 401**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 402**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 403**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 404**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 405**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 406**  io.k8s.api.core.v1.KeyToPath
...
**表 407**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 408**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 409**  io.k8s.api.apps.v1.StatefulSetUpdateStrategy
...
**表 410**  io.k8s.api.apps.v1.RollingUpdateStatefulSetStrategy
...
**表 411**  io.k8s.api.core.v1.PersistentVolumeClaim
...
**表 412**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 413**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 414**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 415**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 416**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 417**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 418**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 419**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 420**  io.k8s.api.core.v1.PersistentVolumeClaimSpec
...
**表 421**  io.k8s.api.core.v1.ResourceRequirements
...
**表 422**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 423**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 424**  io.k8s.api.core.v1.PersistentVolumeClaimStatus
...
**表 425**  io.k8s.api.core.v1.PersistentVolumeClaimCondition
...
**表 426**  io.k8s.api.apps.v1.StatefulSetStatus
...
**表 427**  io.k8s.api.apps.v1.StatefulSetCondition
