# 删除Volcano Job<a name="deleteBatchVolcanoShV1alpha1NamespacedJob"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=deleteBatchVolcanoShV1alpha1NamespacedJob)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
**表 7**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails
...
**表 8**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause
...
**表 9**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta
...
**表 11**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails
...
**表 12**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause
