# 查询用户所有的Jobs<a name="listBatchV1JobForAllNamespaces"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=listBatchV1JobForAllNamespaces)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
|items|Array of io.k8s.api.batch.v1.Job objects|items is the list of Jobs.|
...
|metadata|io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta_v2 object|Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata|


**表 4**  io.k8s.api.batch.v1.Job
...
**表 13**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 14**  io.k8s.api.core.v1.PodSpec
...
**表 15**  io.k8s.api.core.v1.Affinity
...
**表 16**  io.k8s.api.core.v1.NodeAffinity
...
**表 17**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 18**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 19**  io.k8s.api.core.v1.NodeSelector
...
**表 20**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 21**  io.k8s.api.core.v1.PodAffinity
...
**表 22**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 23**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 24**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 25**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 26**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 27**  io.k8s.api.core.v1.PodDNSConfig
...
**表 28**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 29**  io.k8s.api.core.v1.HostAlias
...
**表 30**  io.k8s.api.core.v1.LocalObjectReference
...
**表 31**  io.k8s.api.core.v1.Container
...
**表 32**  io.k8s.api.core.v1.EnvFromSource
...
**表 33**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 34**  io.k8s.api.core.v1.SecretEnvSource
...
**表 35**  io.k8s.api.core.v1.ContainerPort
...
**表 36**  io.k8s.api.core.v1.SecurityContext
...
**表 37**  io.k8s.api.core.v1.Capabilities
...
**表 38**  io.k8s.api.core.v1.VolumeDevice
...
**表 39**  io.k8s.api.core.v1.Process
...
**表 40**  io.k8s.api.core.v1.EnvVar
...
**表 41**  io.k8s.api.core.v1.EnvVarSource
...
**表 42**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 43**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 44**  io.k8s.api.core.v1.SecretKeySelector
...
**表 45**  io.k8s.api.core.v1.Lifecycle
...
**表 46**  io.k8s.api.core.v1.Handler
...
**表 47**  io.k8s.api.core.v1.ObjectReference
...
**表 50**  io.k8s.api.core.v1.ExecAction
...
**表 51**  io.k8s.api.core.v1.HTTPGetAction
...
**表 52**  io.k8s.api.core.v1.HTTPHeader
...
**表 53**  io.k8s.api.core.v1.TCPSocketAction
...
**表 54**  io.k8s.api.core.v1.ResourceRequirements
...
**表 55**  io.k8s.api.core.v1.VolumeMount
...
**表 56**  io.k8s.api.core.v1.Policy
...
**表 58**  io.k8s.api.core.v1.PodReadinessGate
...
**表 59**  io.k8s.api.core.v1.PodSecurityContext
...
**表 60**  io.k8s.api.core.v1.SELinuxOptions
...
**表 61**  io.k8s.api.core.v1.Sysctl
...
**表 62**  io.k8s.api.core.v1.Toleration
...
**表 63**  io.k8s.api.core.v1.Volume
...
**表 64**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 65**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 66**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 67**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 68**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 69**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 70**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 71**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 72**  io.k8s.api.core.v1.FCVolumeSource
...
**表 73**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 74**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 75**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 76**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 77**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 78**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 79**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 80**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 81**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 82**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 83**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 84**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 85**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 86**  io.k8s.api.core.v1.VolumeProjection
...
**表 87**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 88**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 89**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 90**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 91**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 92**  io.k8s.api.core.v1.SecretProjection
...
**表 93**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 94**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 95**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 96**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 97**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 98**  io.k8s.api.core.v1.KeyToPath
...
**表 99**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 100**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 101**  io.k8s.api.batch.v1.JobStatus
...
**表 102**  io.k8s.api.batch.v1.JobCondition
...
**表 103**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
