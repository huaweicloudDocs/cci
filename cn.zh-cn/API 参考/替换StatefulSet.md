# 替换StatefulSet<a name="replaceAppsV1NamespacedStatefulSet"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=replaceAppsV1NamespacedStatefulSet)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
|参数|是否必选|参数类型|描述|
|--|--|--|--|
|name|是|String|name of the StatefulSet|
...
将创建StatefulSet创建的StatefulSet的replica改为2。
