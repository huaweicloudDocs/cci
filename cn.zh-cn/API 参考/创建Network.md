# 创建Network<a name="createNetworkingCciIoV1beta1NamespacedNetwork"></a>
...
具体如何创建一个Network对象，可以参考[Namespace和Network](Namespace和Network.md)

## 调试<a name="atuogenerate_1"></a>

您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=createNetworkingCciIoV1beta1NamespacedNetwork)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
|spec|否|io.k8s.api.cci.v1beta1.NetworkSpec object|Spec defines the attributes on a network|
|status|否|io.k8s.api.cci.v1beta1.NetworkStatus object|Status describes the network status|
...
**表 13**  io.k8s.api.cci.v1beta1.NetworkSpec

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|attachedVPC|是|String|ID of the VPC to attach|
|availableZone|是|String|available zone|
|cidr|是|String|The CIDR of the network|
|networkID|是|String|network ID|
|networkType|是|String|network type like 'overlay_l2'|
|subnetID|是|String|Subnet ID|


**表 14**  io.k8s.api.cci.v1beta1.NetworkStatus

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|message|否|String|Message describes why network is in current state|
|state|否|String|State describes the network state|
...
|spec|io.k8s.api.cci.v1beta1.NetworkSpec object|Spec defines the attributes on a network|
|status|io.k8s.api.cci.v1beta1.NetworkStatus object|Status describes the network status|


**表 16**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 17**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 18**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 19**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 20**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 21**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 22**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 23**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 24**  io.k8s.api.cci.v1beta1.NetworkSpec

|参数|参数类型|描述|
|--|--|--|
|attachedVPC|String|ID of the VPC to attach|
|availableZone|String|available zone|
...
**表 25**  io.k8s.api.cci.v1beta1.NetworkStatus
...
**表 27**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 28**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 29**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 30**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 31**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 32**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 33**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 34**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 35**  io.k8s.api.cci.v1beta1.NetworkSpec
...
**表 36**  io.k8s.api.cci.v1beta1.NetworkStatus
...
**表 38**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 39**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 40**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 41**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 42**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 43**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 44**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 45**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 46**  io.k8s.api.cci.v1beta1.NetworkSpec
...
**表 47**  io.k8s.api.cci.v1beta1.NetworkStatus
...
metadata.annotations必选字段数据结构说明
...
|参数|是否必选|参数类型|描述|
|--|--|--|--|
|cidr|No|String|Network对应VPC子网的网段。**说明：**此处VPC和子网的网段不能为10.247.0.0/16，10.247.0.0/16是云容器实例预留给Service的网段。如果您使用此网段，后续可能会造成IP冲突，导致负载无法创建或服务不可用；如果您不需要通过Service访问，而是直接访问Pod，则可以使用此网段。|
