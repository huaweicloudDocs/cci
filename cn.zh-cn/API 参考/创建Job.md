# 创建Job<a name="createBatchV1NamespacedJob"></a>

## 功能介绍

创建Job。 创建Job时挂载OBS的使用限制请参见[挂载OBS使用限制](挂载OBS使用限制.md)。
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CCI&api=createBatchV1NamespacedJob)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
|spec|否|io.k8s.api.batch.v1.JobSpec object|Specification of the desired behavior of a job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status|
|status|否|io.k8s.api.batch.v1.JobStatus object|Current status of a job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status|


**表 5**  io.k8s.api.batch.v1.JobSpec

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|activeDeadlineSeconds|否|Long|Specifies the duration in seconds relative to the startTime that the job may be active before the system tries to terminate it; value must be positive integer|
|backoffLimit|否|Integer|Specifies the number of retries before marking this job failed. Defaults to 6|
|completions|否|Integer|Specifies the desired number of successfully finished pods the job should be run with.  Setting to nil means that the success of any pod signals the success of all pods, and allows parallelism to have any positive value.  Setting to 1 means that parallelism is limited to 1 and the success of that pod signals the success of the job. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/|
|manualSelector|否|Boolean|manualSelector controls generation of pod labels and pod selectors. Leave *manualSelector* unset unless you are certain what you are doing. When false or unset, the system pick labels unique to this job and appends those labels to the pod template.  When true, the user is responsible for picking unique labels and specifying the selector.  Failure to pick a unique label may cause this and other jobs to not function correctly.  However, You may see *manualSelector=true* in jobs that were created with the old *extensions/v1beta1* API. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/#specifying-your-own-pod-selector|
|parallelism|否|Integer|Specifies the maximum desired number of pods the job should run at any given time. The actual number of pods running in steady state will be less than this number when ((.spec.completions - .status.successful) < .spec.parallelism), i.e. when the work left to do is less than max parallelism. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/|
|selector|否|io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector object|A label query over pods that should match the pod count. Normally, the system sets this field for you. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors|
|template|是|io.k8s.api.core.v1.PodTemplateSpec object|Describes the pod that will be created when executing a job. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/|
...
**表 7**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 8**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 9**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 10**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 11**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 12**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 13**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 15**  io.k8s.api.core.v1.PodSpec
...
**表 16**  io.k8s.api.core.v1.Affinity
...
**表 17**  io.k8s.api.core.v1.NodeAffinity
...
**表 18**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 19**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 20**  io.k8s.api.core.v1.NodeSelector
...
**表 21**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 22**  io.k8s.api.core.v1.PodAffinity
...
**表 23**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 24**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 25**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 26**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 27**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 28**  io.k8s.api.core.v1.PodDNSConfig
...
**表 29**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 30**  io.k8s.api.core.v1.HostAlias
...
**表 31**  io.k8s.api.core.v1.LocalObjectReference
...
**表 32**  io.k8s.api.core.v1.Container
...
**表 33**  io.k8s.api.core.v1.EnvFromSource
...
**表 34**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 35**  io.k8s.api.core.v1.SecretEnvSource
...
**表 36**  io.k8s.api.core.v1.ContainerPort
...
**表 37**  io.k8s.api.core.v1.SecurityContext
...
**表 38**  io.k8s.api.core.v1.Capabilities
...
**表 39**  io.k8s.api.core.v1.VolumeDevice
...
**表 40**  io.k8s.api.core.v1.Process
...
**表 41**  io.k8s.api.core.v1.EnvVar
...
**表 42**  io.k8s.api.core.v1.EnvVarSource
...
**表 43**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 44**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 45**  io.k8s.api.core.v1.SecretKeySelector
...
**表 46**  io.k8s.api.core.v1.Lifecycle
...
**表 47**  io.k8s.api.core.v1.Handler
...
**表 48**  io.k8s.api.core.v1.ObjectReference
...
**表 51**  io.k8s.api.core.v1.ExecAction
...
**表 52**  io.k8s.api.core.v1.HTTPGetAction
...
**表 53**  io.k8s.api.core.v1.HTTPHeader
...
**表 54**  io.k8s.api.core.v1.TCPSocketAction
...
**表 55**  io.k8s.api.core.v1.ResourceRequirements
...
**表 56**  io.k8s.api.core.v1.VolumeMount
...
**表 57**  io.k8s.api.core.v1.Policy
...
**表 59**  io.k8s.api.core.v1.PodReadinessGate
...
**表 60**  io.k8s.api.core.v1.PodSecurityContext
...
**表 61**  io.k8s.api.core.v1.SELinuxOptions
...
**表 62**  io.k8s.api.core.v1.Sysctl
...
**表 63**  io.k8s.api.core.v1.Toleration
...
**表 64**  io.k8s.api.core.v1.Volume
...
**表 65**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 66**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 67**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 68**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 69**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 70**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 71**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 72**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 73**  io.k8s.api.core.v1.FCVolumeSource
...
**表 74**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 75**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 76**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 77**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 78**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 79**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 80**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 81**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 82**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 83**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 84**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 85**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 86**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 87**  io.k8s.api.core.v1.VolumeProjection
...
**表 88**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 89**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 90**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 91**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 92**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 93**  io.k8s.api.core.v1.SecretProjection
...
**表 94**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 95**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 96**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 97**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 98**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 99**  io.k8s.api.core.v1.KeyToPath
...
**表 100**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 101**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 102**  io.k8s.api.batch.v1.JobStatus

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|active|否|Integer|The number of actively running pods.|
|completionTime|否|String|Represents time when the job was completed. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.|
|conditions|否|Array of io.k8s.api.batch.v1.JobCondition objects|The latest available observations of an object's current state. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/|
|failed|否|Integer|The number of pods which reached phase Failed.|
|startTime|否|String|Represents time when the job was acknowledged by the job controller. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.|
|succeeded|否|Integer|The number of pods which reached phase Succeeded.|


**表 103**  io.k8s.api.batch.v1.JobCondition

|参数|是否必选|参数类型|描述|
|--|--|--|--|
|lastProbeTime|否|String|Last time the condition was checked.|
|lastTransitionTime|否|String|Last time the condition transit from one status to another.|
|message|否|String|Human readable message indicating details about last transition.|
|reason|否|String|(brief) reason for the condition's last transition.|
|status|是|String|Status of the condition, one of True, False, Unknown.|
|type|是|String|Type of job condition, Complete or Failed.|
...
|spec|io.k8s.api.batch.v1.JobSpec object|Specification of the desired behavior of a job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status|
|status|io.k8s.api.batch.v1.JobStatus object|Current status of a job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status|


**表 105**  io.k8s.api.batch.v1.JobSpec

|参数|参数类型|描述|
|--|--|--|
|activeDeadlineSeconds|Long|Specifies the duration in seconds relative to the startTime that the job may be active before the system tries to terminate it; value must be positive integer|
...
|selector|io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector object|A label query over pods that should match the pod count. Normally, the system sets this field for you. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors|
|template|io.k8s.api.core.v1.PodTemplateSpec object|Describes the pod that will be created when executing a job. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/|


**表 106**  io.k8s.api.core.v1.PodTemplateSpec
...
**表 107**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 108**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 109**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 110**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 111**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 112**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 113**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 114**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 115**  io.k8s.api.core.v1.PodSpec
...
**表 116**  io.k8s.api.core.v1.Affinity
...
**表 117**  io.k8s.api.core.v1.NodeAffinity
...
**表 118**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 119**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 120**  io.k8s.api.core.v1.NodeSelector
...
**表 121**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 122**  io.k8s.api.core.v1.PodAffinity
...
**表 123**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 124**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 125**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 126**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 127**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 128**  io.k8s.api.core.v1.PodDNSConfig
...
**表 129**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 130**  io.k8s.api.core.v1.HostAlias
...
**表 131**  io.k8s.api.core.v1.LocalObjectReference
...
**表 132**  io.k8s.api.core.v1.Container
...
**表 133**  io.k8s.api.core.v1.EnvFromSource
...
**表 134**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 135**  io.k8s.api.core.v1.SecretEnvSource
...
**表 136**  io.k8s.api.core.v1.ContainerPort
...
**表 137**  io.k8s.api.core.v1.SecurityContext
...
**表 138**  io.k8s.api.core.v1.Capabilities
...
**表 139**  io.k8s.api.core.v1.VolumeDevice
...
**表 140**  io.k8s.api.core.v1.Process
...
**表 141**  io.k8s.api.core.v1.EnvVar
...
**表 142**  io.k8s.api.core.v1.EnvVarSource
...
**表 143**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 144**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 145**  io.k8s.api.core.v1.SecretKeySelector
...
**表 146**  io.k8s.api.core.v1.Lifecycle
...
**表 147**  io.k8s.api.core.v1.Handler
...
**表 148**  io.k8s.api.core.v1.ObjectReference
...
**表 150**  io.k8s.api.core.v1.Probe
...
**表 151**  io.k8s.api.core.v1.ExecAction
...
**表 152**  io.k8s.api.core.v1.HTTPGetAction
...
**表 153**  io.k8s.api.core.v1.HTTPHeader
...
**表 154**  io.k8s.api.core.v1.TCPSocketAction
...
**表 155**  io.k8s.api.core.v1.ResourceRequirements
...
**表 156**  io.k8s.api.core.v1.VolumeMount
...
**表 157**  io.k8s.api.core.v1.Policy
...
**表 159**  io.k8s.api.core.v1.PodReadinessGate
...
**表 160**  io.k8s.api.core.v1.PodSecurityContext
...
**表 161**  io.k8s.api.core.v1.SELinuxOptions
...
**表 162**  io.k8s.api.core.v1.Sysctl
...
**表 163**  io.k8s.api.core.v1.Toleration
...
**表 164**  io.k8s.api.core.v1.Volume
...
**表 165**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 166**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 167**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 168**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 169**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 170**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 171**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 172**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 173**  io.k8s.api.core.v1.FCVolumeSource
...
**表 174**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 175**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 176**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 177**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 178**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 179**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 180**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 181**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 182**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 183**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 184**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 185**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 186**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 187**  io.k8s.api.core.v1.VolumeProjection
...
**表 188**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 189**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 190**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 191**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 192**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 193**  io.k8s.api.core.v1.SecretProjection
...
**表 194**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 195**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 196**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 197**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 198**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 199**  io.k8s.api.core.v1.KeyToPath
...
**表 200**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 201**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 202**  io.k8s.api.batch.v1.JobStatus

|参数|参数类型|描述|
|--|--|--|
|active|Integer|The number of actively running pods.|
|completionTime|String|Represents time when the job was completed. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.|
|conditions|Array of io.k8s.api.batch.v1.JobCondition objects|The latest available observations of an object's current state. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/|
|failed|Integer|The number of pods which reached phase Failed.|
|startTime|String|Represents time when the job was acknowledged by the job controller. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.|
|succeeded|Integer|The number of pods which reached phase Succeeded.|


**表 203**  io.k8s.api.batch.v1.JobCondition
...
**表 205**  io.k8s.api.batch.v1.JobSpec
...
**表 206**  io.k8s.api.core.v1.PodTemplateSpec
...
**表 207**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 208**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 209**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 210**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 211**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 212**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 213**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 214**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 215**  io.k8s.api.core.v1.PodSpec
...
**表 216**  io.k8s.api.core.v1.Affinity
...
**表 217**  io.k8s.api.core.v1.NodeAffinity
...
**表 218**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 219**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 220**  io.k8s.api.core.v1.NodeSelector
...
**表 221**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 222**  io.k8s.api.core.v1.PodAffinity
...
**表 223**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 224**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 225**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 226**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 227**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 228**  io.k8s.api.core.v1.PodDNSConfig
...
**表 229**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 230**  io.k8s.api.core.v1.HostAlias
...
**表 231**  io.k8s.api.core.v1.LocalObjectReference
...
**表 232**  io.k8s.api.core.v1.Container
...
**表 233**  io.k8s.api.core.v1.EnvFromSource
...
**表 234**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 235**  io.k8s.api.core.v1.SecretEnvSource
...
**表 236**  io.k8s.api.core.v1.ContainerPort
...
**表 237**  io.k8s.api.core.v1.SecurityContext
...
**表 238**  io.k8s.api.core.v1.Capabilities
...
**表 239**  io.k8s.api.core.v1.VolumeDevice
...
**表 240**  io.k8s.api.core.v1.Process
...
**表 241**  io.k8s.api.core.v1.EnvVar
...
**表 242**  io.k8s.api.core.v1.EnvVarSource
...
**表 243**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 244**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 245**  io.k8s.api.core.v1.SecretKeySelector
...
**表 246**  io.k8s.api.core.v1.Lifecycle
...
**表 247**  io.k8s.api.core.v1.Handler
...
**表 248**  io.k8s.api.core.v1.ObjectReference
...
**表 250**  io.k8s.api.core.v1.Probe
...
**表 251**  io.k8s.api.core.v1.ExecAction
...
**表 252**  io.k8s.api.core.v1.HTTPGetAction
...
**表 253**  io.k8s.api.core.v1.HTTPHeader
...
**表 254**  io.k8s.api.core.v1.TCPSocketAction
...
**表 255**  io.k8s.api.core.v1.ResourceRequirements
...
**表 256**  io.k8s.api.core.v1.VolumeMount
...
**表 257**  io.k8s.api.core.v1.Policy
...
**表 259**  io.k8s.api.core.v1.PodReadinessGate
...
**表 260**  io.k8s.api.core.v1.PodSecurityContext
...
**表 261**  io.k8s.api.core.v1.SELinuxOptions
...
**表 262**  io.k8s.api.core.v1.Sysctl
...
**表 263**  io.k8s.api.core.v1.Toleration
...
**表 264**  io.k8s.api.core.v1.Volume
...
**表 265**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 266**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 267**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 268**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 269**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 270**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 271**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 272**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 273**  io.k8s.api.core.v1.FCVolumeSource
...
**表 274**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 275**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 276**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 277**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 278**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 279**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 280**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 281**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 282**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 283**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 284**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 285**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 286**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 287**  io.k8s.api.core.v1.VolumeProjection
...
**表 288**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 289**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 290**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 291**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 292**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 293**  io.k8s.api.core.v1.SecretProjection
...
**表 294**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 295**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 296**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 297**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 298**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 299**  io.k8s.api.core.v1.KeyToPath
...
**表 300**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 301**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 302**  io.k8s.api.batch.v1.JobStatus
...
**表 303**  io.k8s.api.batch.v1.JobCondition
...
**表 305**  io.k8s.api.batch.v1.JobSpec
...
**表 306**  io.k8s.api.core.v1.PodTemplateSpec
...
**表 307**  io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta\_v3
...
**表 308**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializers\_v3
...
**表 309**  io.k8s.apimachinery.pkg.apis.meta.v1.Initializer\_v2
...
**表 310**  io.k8s.apimachinery.pkg.apis.meta.v1.Status\_v3
...
**表 311**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusDetails\_v3
...
**表 312**  io.k8s.apimachinery.pkg.apis.meta.v1.StatusCause\_v2
...
**表 313**  io.k8s.apimachinery.pkg.apis.meta.v1.ListMeta\_v2
...
**表 314**  io.k8s.apimachinery.pkg.apis.meta.v1.OwnerReference\_v2
...
**表 315**  io.k8s.api.core.v1.PodSpec
...
**表 316**  io.k8s.api.core.v1.Affinity
...
**表 317**  io.k8s.api.core.v1.NodeAffinity
...
**表 318**  io.k8s.api.core.v1.PreferredSchedulingTerm
...
**表 319**  io.k8s.api.core.v1.NodeSelectorTerm
...
**表 320**  io.k8s.api.core.v1.NodeSelector
...
**表 321**  io.k8s.api.core.v1.NodeSelectorRequirement
...
**表 322**  io.k8s.api.core.v1.PodAffinity
...
**表 323**  io.k8s.api.core.v1.PodAntiAffinity
...
**表 324**  io.k8s.api.core.v1.WeightedPodAffinityTerm
...
**表 325**  io.k8s.api.core.v1.PodAffinityTerm
...
**表 326**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector
...
**表 327**  io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement
...
**表 328**  io.k8s.api.core.v1.PodDNSConfig
...
**表 329**  io.k8s.api.core.v1.PodDNSConfigOption
...
**表 330**  io.k8s.api.core.v1.HostAlias
...
**表 331**  io.k8s.api.core.v1.LocalObjectReference
...
**表 332**  io.k8s.api.core.v1.Container
...
**表 333**  io.k8s.api.core.v1.EnvFromSource
...
**表 334**  io.k8s.api.core.v1.ConfigMapEnvSource
...
**表 335**  io.k8s.api.core.v1.SecretEnvSource
...
**表 336**  io.k8s.api.core.v1.ContainerPort
...
**表 337**  io.k8s.api.core.v1.SecurityContext
...
**表 338**  io.k8s.api.core.v1.Capabilities
...
**表 339**  io.k8s.api.core.v1.VolumeDevice
...
**表 340**  io.k8s.api.core.v1.Process
...
**表 341**  io.k8s.api.core.v1.EnvVar
...
**表 342**  io.k8s.api.core.v1.EnvVarSource
...
**表 343**  io.k8s.api.core.v1.ConfigMapKeySelector
...
**表 344**  io.k8s.api.core.v1.ProcessResourceFieldSelector
...
**表 345**  io.k8s.api.core.v1.SecretKeySelector
...
**表 346**  io.k8s.api.core.v1.Lifecycle
...
**表 347**  io.k8s.api.core.v1.Handler
...
**表 348**  io.k8s.api.core.v1.ObjectReference
...
**表 350**  io.k8s.api.core.v1.Probe
...
**表 351**  io.k8s.api.core.v1.ExecAction
...
**表 352**  io.k8s.api.core.v1.HTTPGetAction
...
**表 353**  io.k8s.api.core.v1.HTTPHeader
...
**表 354**  io.k8s.api.core.v1.TCPSocketAction
...
**表 355**  io.k8s.api.core.v1.ResourceRequirements
...
**表 356**  io.k8s.api.core.v1.VolumeMount
...
**表 357**  io.k8s.api.core.v1.Policy
...
**表 359**  io.k8s.api.core.v1.PodReadinessGate
...
**表 360**  io.k8s.api.core.v1.PodSecurityContext
...
**表 361**  io.k8s.api.core.v1.SELinuxOptions
...
**表 362**  io.k8s.api.core.v1.Sysctl
...
**表 363**  io.k8s.api.core.v1.Toleration
...
**表 364**  io.k8s.api.core.v1.Volume
...
**表 365**  io.k8s.api.core.v1.AWSElasticBlockStoreVolumeSource
...
**表 366**  io.k8s.api.core.v1.AzureDiskVolumeSource
...
**表 367**  io.k8s.api.core.v1.AzureFileVolumeSource
...
**表 368**  io.k8s.api.core.v1.CephFSVolumeSource
...
**表 369**  io.k8s.api.core.v1.CinderVolumeSource
...
**表 370**  io.k8s.api.core.v1.ConfigMapVolumeSource
...
**表 371**  io.k8s.api.core.v1.DownwardAPIVolumeSource
...
**表 372**  io.k8s.api.core.v1.EmptyDirVolumeSource
...
**表 373**  io.k8s.api.core.v1.FCVolumeSource
...
**表 374**  io.k8s.api.core.v1.FlexVolumeSource
...
**表 375**  io.k8s.api.core.v1.FlockerVolumeSource
...
**表 376**  io.k8s.api.core.v1.GCEPersistentDiskVolumeSource
...
**表 377**  io.k8s.api.core.v1.GitRepoVolumeSource
...
**表 378**  io.k8s.api.core.v1.GlusterfsVolumeSource
...
**表 379**  io.k8s.api.core.v1.HostPathVolumeSource
...
**表 380**  io.k8s.api.core.v1.ISCSIVolumeSource
...
**表 381**  io.k8s.api.core.v1.LocalDirVolumeSource
...
**表 382**  io.k8s.api.core.v1.NFSVolumeSource
...
**表 383**  io.k8s.api.core.v1.PersistentVolumeClaimVolumeSource
...
**表 384**  io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource
...
**表 385**  io.k8s.api.core.v1.PortworxVolumeSource
...
**表 386**  io.k8s.api.core.v1.ProjectedVolumeSource
...
**表 387**  io.k8s.api.core.v1.VolumeProjection
...
**表 388**  io.k8s.api.core.v1.ConfigMapProjection
...
**表 389**  io.k8s.api.core.v1.DownwardAPIProjection
...
**表 390**  io.k8s.api.core.v1.DownwardAPIVolumeFile
...
**表 391**  io.k8s.api.core.v1.ObjectFieldSelector
...
**表 392**  io.k8s.api.core.v1.ResourceFieldSelector
...
**表 393**  io.k8s.api.core.v1.SecretProjection
...
**表 394**  io.k8s.api.core.v1.ServiceAccountTokenProjection
...
**表 395**  io.k8s.api.core.v1.QuobyteVolumeSource
...
**表 396**  io.k8s.api.core.v1.RBDVolumeSource
...
**表 397**  io.k8s.api.core.v1.ScaleIOVolumeSource
...
**表 398**  io.k8s.api.core.v1.SecretVolumeSource
...
**表 399**  io.k8s.api.core.v1.KeyToPath
...
**表 400**  io.k8s.api.core.v1.StorageOSVolumeSource
...
**表 401**  io.k8s.api.core.v1.VsphereVirtualDiskVolumeSource
...
**表 402**  io.k8s.api.batch.v1.JobStatus
...
**表 403**  io.k8s.api.batch.v1.JobCondition
