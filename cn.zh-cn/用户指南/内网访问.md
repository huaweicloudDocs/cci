...
## 使用kubectl创建ELB访问<a name="section1661020984412"></a>

ELB访问需要配合Service和Ingress两个Kubernetes对象，具体请参见[Ingress](https://support.huaweicloud.com/devg-cci/cci_05_0008.html)。
