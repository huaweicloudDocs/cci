...
定时任务（CronJob）是基于时间控制的短时任务（Job），类似于Linux系统的crontab，在指定的时间周期运行指定的短时任务。

## 创建定时任务<a name="section145271625910"></a>

1.  登录云容器实例管理控制台，左侧导航栏中选择[工作负载 \> 定时任务](https://console.huaweicloud.com/cci/#/app/workload/cronjob/list)，在右侧页面单击“创建定时任务“。
2.  添加基本信息。
    -   **任务名称**
